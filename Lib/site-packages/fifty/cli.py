...
Options:
  ...
  --down SCALE_DOWN                         Path to file with specific filetypes (from our list of 75 filetypes). See utilities/scale_down.txt for reference [default: ].
...
def main():
    ...
    for k, v in options.items():
        if hasattr(commands, k) and v is not False:
